...
const HeroSection = () => {
  return (
    <section id="home"className="px-4 max-w-7xl mx-auto text-left pt-10">
      ...
      {/* Checkboxes Section (Left Aligned + Circular Checkmarks) */}
          ...
          <div className="max-w-7xl mx-auto px-12">
            <div className="flex flex-wrap md:flex-nowrap gap-8">
                ...
                <div className="grid grid-cols-3 gap-6">
                  {[...Array(6)].map((_, index) => (
                   <img 
                     ...
                     src={"/home1.png"} 
                     alt={`Image ${index + 1}`} 
                     className="w-36 h-24 object-cover rounded-lg shadow-sm hover:shadow-md transition-all"
                   />
                  ))}
                </div>
              ...
              <div className="w-full md:w-1/2 bg-gray-50/80 p-8 pr-24 rounded-xl shadow-md">
                <img src="/home2.jpg" alt="Main Feature" className="w-[400px] h-[220px] rounded-lg shadow-lg object-cover"/>
                <div className="mt-6 flex items-center gap-2">
                  <p className="text-gray-700 text-lg font-medium">Data Vidhya</p>
